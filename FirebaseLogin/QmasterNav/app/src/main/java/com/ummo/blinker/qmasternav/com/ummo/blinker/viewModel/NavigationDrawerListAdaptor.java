...
import com.ummo.blinker.qmasternav.R;
 ...
 */
public class NavigationDrawerListAdaptor extends BaseAdapter{

    private Context context;
    private ArrayList<NavigationDrawerItem> navDrawerItems;

    public NavigationDrawerListAdaptor(Context context, ArrayList<NavigationDrawerItem> navDrawerItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        title.setText((CharSequence) navDrawerItems.get(position).getLabel());
