...
public class ExpandableView extends RelativeLayout
{
    ...
    private List<ViewGroup> outsideContentLayoutList2;
    ...
    private void init()
    {
        ...
        clickableLayout.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    collapse();
                    //outsideContentLayoutList.clear();
                }
                else
                {
        //            contentLayout.setVisibility(GONE);
    ...
    public void setOutsideContentLayout(ViewGroup outsideContentLayout)
    {
        ...
        outsideContentLayoutList2 = outsideContentLayoutList;
    }
    ...
    public void fill_Data(String text, boolean useChevron)
    {
        textView.setText(text);
